# F1Wiki
## Get Formula 1 Stats and Create Your Own Fantasy League



F1Wiki is a single page application that allows the user to:

- See the F1 Drivers' Championship standings.
- See the F1 Constructors' Championship standings.
...
F1Wiki uses the React Bootstrap open source project. https://react-bootstrap.github.io/
